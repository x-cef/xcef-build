...
class ReleaseTests(unittest.TestCase):
    ...
    def test_default_matrix_has_five_cef151_targets(self):
        self.assertEqual(len(self.rows), 5)
        self.assertEqual({(r['platform'], r['architecture']) for r in self.rows}, {('windows', 'x64'), ('macos', 'arm64'), ('macos', 'x64'), ('linux', 'x64'), ('linux', 'arm64')})
